...
$(function () {
    ...
    ***************************/
    ...
    document.addEventListener('swup:contentReplaced', function() {
        initAnimations();
        initSlider(); // Asegúrate de que esta función inicializa o actualiza el slider correctamente
    });
    ...
    ***************************/
    function updateSlideInfo(swiperInstance) {
        ...
        var name, date, author, style;
    
        // If the active slide has the data attributes, use them
        if (activeSlide && activeSlide.hasAttribute('data-name2')) {
            name = activeSlide.getAttribute('data-name2');
            date = activeSlide.getAttribute('data-date2');
            author = activeSlide.getAttribute('data-author2');
            style = activeSlide.getAttribute('data-style2');
        } else {
            // Manually set the details for the first image
            name = 'M';
            date = '2017';
