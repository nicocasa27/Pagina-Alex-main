...
$(function () {
    ...
    ***************************/
    ...
    function updateSlideInfo() {
        // Attempt to find the active slide
        var activeSlide = document.querySelector('.slidervila .swiper-slide-active');
    
        // If there's no active slide (e.g., on initial load), select the first slide
        if (!activeSlide) {
            activeSlide = document.querySelector('.slidervila .swiper-slide');
        }
    
        // Update the information if a slide is found
        if (activeSlide) {
            var name = activeSlide.getAttribute('data-name2') || 'Default Name';
            var date = activeSlide.getAttribute('data-date2') || 'Default Date';
            var author = activeSlide.getAttribute('data-author2') || 'Default Author';
            var style = activeSlide.getAttribute('data-style2') || 'Default Style';
    
            document.querySelector('.mil-info .name').textContent = name;
            document.querySelector('.mil-info .date').textContent = date;
            document.querySelector('.mil-info .author').textContent = author;
    ...
    function initAnimations() {
        // Crear una nueva línea de tiempo solo si los elementos existen
    ...
    ***************************/
    // 1 item slider
var swiper = new Swiper('.slidervila', {
    slidesPerView: 1,
    spaceBetween: 30,
    speed: 800,
    parallax: true,
    ...
    on: {
        slideChange: function () {
            ...
            var name = activeSlide.getAttribute('data-name2');
            var date = activeSlide.getAttribute('data-date2');
            var author = activeSlide.getAttribute('data-author2');
            var style = activeSlide.getAttribute('data-style2');
...
// var swiper = new Swiper('.slidereva', {
//     slidesPerView: 1,
//     spaceBetween: 30,
//     speed: 800,
//     parallax: true,
...
//         slideChange: function () {
//             var activeSlide = this.slides[this.activeIndex];
//             var name = activeSlide.getAttribute('data-name1');
//             var date = activeSlide.getAttribute('data-date1');
//             var author = activeSlide.getAttribute('data-author1');
//             var style = activeSlide.getAttribute('data-style1');
...
var swiper = new Swiper('.slidereva', {
    ...
    on: {
        init: function() {
            // This will call updateSlideInfo when Swiper initializes
...
function updateSlideInfo(swiperInstance) {
    ...
    var name = activeSlide.getAttribute('data-name1') || 'Default Name';
    var date = activeSlide.getAttribute('data-date1') || 'Default Date';
    var author = activeSlide.getAttribute('data-author1') || 'Default Author';
    var style = activeSlide.getAttribute('data-style1') || 'Default Style';
